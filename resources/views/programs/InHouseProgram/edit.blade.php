        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body  p-4">
                    ...
                    {{$editProgram}}
                        @if(true)
                        <form action="{{ route('programs/inhouse/update')}}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                {{ csrf_field() }}
                                {{method_field('PATCH')}}
                                ...
                                <div class="col col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{old('lecturerCost')}}" class="form-control {{ $errors->has('lecturerCost') ? 'is-invalid' : '' }}" id="lecturerCost" name="lecturerCost" placeholder="Lecturer Cost">
