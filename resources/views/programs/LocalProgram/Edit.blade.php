...
@section('main-content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            ...
            <a href="{{route('local.show', $program[0]->program_id)}}" class="btn btn-default pull-right"><i class="glyphicon glyphicon-arrow-left margin-right-sm"></i>Back</a>
        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback {{$errors->has('employment_nature') ? 'has-error' : ''}}">
                                ...
                                <div class="inline margin-right-md">
                                    <input type="checkbox" id="employment_permanent" class="styled-checkbox" value="permanent" name="employment_nature[]" {{ (is_array(old('employment_nature')) and in_array('permanent', old('employment_nature')) or \strpos($program[0]->nature_of_the_employment, 'permanent') !== false) ? ' checked' : '' }}>
                                    <label for="employment_permanent">Permanent</label>
                                </div>
                                <div class="inline margin-right-md">
                                    <input type="checkbox" id="employment_fixed_contract" class="styled-checkbox" value="fixed contract" name="employment_nature[]" {{ (is_array(old('employment_nature')) and in_array('fixed contract', old('employment_nature')) or \strpos($program[0]->nature_of_the_employment, 'fixed contract') !== false) ? ' checked' : '' }}>
                                    <label for="employment_fixed_contract">Fixed Contract</label>
                                </div>
                                <div class="inline margin-right-md">
                                    <input type="checkbox" id="employment_job_contract" class="styled-checkbox" value="job contract" name="employment_nature[]" {{ (is_array(old('employment_nature')) and in_array('job contract', old('employment_nature')) or \strpos($program[0]->nature_of_the_employment, 'job contract') !== false) ? ' checked' : '' }}>
