...
<div class="panel panel-default">
    ...
    SELECT noa and technicle
    organised by select or type
    is long turm
    duration dates or months
    1 member fee
    2 non
    3 studen
    file jpeg or pdf doc
    add employee button
    back button
    cat remove both
    summery show all
    ...
    add text area to generate circular letter
    ...
    <div class="panel-body">
        <form method="POST" action="{{ route('programs.create') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-2">
                <div class="form-group has-feedback {{$errors->has('nature_of_the_employment') ? 'has-error' : ''}}">
                    <label for="nature_of_the_employment" class="required">Employment</label>
                    <select class="form-control" id="nature_of_the_employment" name="nature_of_the_employment">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        <label for="is_long_term" class="">
                            Long Term
                            <input type="checkbox" class="form-check" aria-label="" id="is_long_term" name="is_long_term" value="Long Term">
                        </label>
                    </div>
                </div>
                <div class="col-md-8">
            ...
            <div class="col-md-6">
                <div class="form-group has-feedback {{$errors->has('program_brochure') ? 'has-error' : ''}}">
                    ...
                    <small id="program_brochureHelpBlock" class="form-text text-muted">
                        Only JPEG and PDF are allowed. Max size 1999KB.
                    </small>
                </div>
            </div>
            <div class="col-md-12">
