...
@section('main-content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            <p class="" style="">New Local Program</p>
            <a href="{{route('local.index')}}" class="btn btn-default pull-right"><i class="glyphicon glyphicon-arrow-left margin-right-sm"></i>Back</a>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback {{$errors->has('organised_by') ? 'has-error' : ''}}">
                                ...
                                <input type="text" value="{{old('organised_by')}}" class="form-control" name="organised_by_id" id="organised_by" placeholder="Program organiser" list="orgs" required>
                                <datalist id="orgs">
                                    @foreach($orgs as $org)
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback {{$errors->has('venue') ? 'has-error' : ''}}">
                                ...
                                <input type="text" value="{{old('venue')}}" class="form-control" id="venue" name="venue" required>
                                @if ($errors->has('venue'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback {{$errors->has('start_time') ? 'has-error' : ''}}">
                                ...
                                <input type="time" value="{{old('start_time')}}" class="form-control" id="start_time" name="start_time"  required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group has-feedback {{$errors->has('duration') ? 'has-error' : ''}}">
                                ...
                                <input type="number" value="{{old('duration')}}" class="form-control" id="duration" placeholder="Duration" id="duration" name="duration" required>
                        ...
                        <div class="col-md-4 {{$errors->has('duration_by') ? 'has-error' : ''}}" style="margin-top:25px;">
                            <div class="form-group has-feedback">
                                <label class="radio-inline">
                                    <input type="radio" name="duration_by" value="months" {{(old('duration_by') == 'months') ? 'checked' : ''}}>Months
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="duration_by" value="days" {{(old('duration_by') == 'days') ? 'checked' : ''}}>Days
                                </label>
                            </div>
