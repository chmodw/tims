            ...
            <div class="card">
                ...
                <div class="card-body  p-4">
                    ...
                    @endif
                        ...
                        @endif
                        <form action="{{ route('programs/postgrad/update', $editProgram[0]->id) }}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                {{ csrf_field() }}
                                {{method_field('PATCH')}}
                                ...
                                <div class="col col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('institute', $editProgram[0]->institute)}}" class="form-control {{ $errors->has('institute') ? 'is-invalid' : '' }}" name="institute" id="institute" placeholder="Institute of The Program">
                                        @if ($errors->has('institute'))
                                ...
                                <div class="col col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('department', $editProgram[0]->department)}}" name="department" class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" id="department" placeholder="Department">
                                ...
                                <div class="col col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('programs') ? 'is-invalid' : '' }}" style="resize: vertical; min-height: 4em; max-height: 10em;" name="programs" id="programs" placeholder="Available Courses" rows="3">{{old('programs', implode(', ', unserialize($editProgram[0]->programs)))}}</textarea>
                                ...
                                <div class="col col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('requirements') ? 'is-invalid' : '' }}" style="resize: vertical; min-height: 4em; max-height: 10em;" name="requirements" id="requirements" placeholder="Requirements" rows="3">{{old('requirements', implode(', ', unserialize($editProgram[0]->requirements)))}}</textarea>
                                ...
                                <div class="col col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" value="{{old('applicationClosingTime', date("H:i", strtotime($editProgram[0]->applicationClosingDateTime)))}}" class="form-control {{ $errors->has('applicationClosingTime') ? 'is-invalid' : '' }}" id="applicationClosingTime" name="applicationClosingTime" placeholder="HH:MM">
                                ...
                                <div class="col col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"  value="{{old('registrationFees', $editProgram[0]->registrationFees)}}" class="form-control {{ $errors->has('registrationFees') ? 'is-invalid' : '' }}" id="registrationFees" name="registrationFees" placeholder="Registration Fees">
                                ...
                                <div class="col col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{old('firstYearFees', $editProgram[0]->firstYearFees)}}" class="form-control {{ $errors->has('firstYearFees') ? 'is-invalid' : '' }}" id="firstYearFees" name="firstYearFees" placeholder="First Year Fees">
                                ...
                                <div class="col col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{old('secondYearFees', $editProgram[0]->secondYearFees)}}" class="form-control {{ $errors->has('secondYearFees') ? 'is-invalid' : '' }}" id="secondYearFees" name="secondYearFees" placeholder="Second Year Fees">
