...
@section('content_header')
    <h1 class="inline">New Foreign Training Program</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="from-group has-feedback {{$errors->has('program_fee') ? 'has-error' : ''}}">
                            ...
                            <input type="number" value="{{old('program_fee')}}" class="form-control {{ $errors->has('program_fee') ? 'has-error' : '' }}" id="program_fee" name="program_fee" placeholder="program_fee">
