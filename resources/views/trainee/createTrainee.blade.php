    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Create new Trainee</h4>
        </div>
            ...
            <div class="row">
              ...
              <div class="col col-md-12">
                <div class="form-group">
                  <label for="sectionName">Sameple data</label>
              ...
              <div class="col col-md-5">
                <div class="form-group">
                  <label for="organisedBy">Sameple data</label>
              ...
              <div class="col col-md-7">
                <div class="form-group">
                  <label for="notifiedBy">Sameple data</label>
                  <input type="text" value="{{old('section_hod')}}" name="section_hod" class="form-control {{ $errors->has('section_hod') ? 'is-invalid' : '' }}" id="section_hod" placeholder="Sameple data ">
              ...
              <div class="col col-md-12">
                <div class="form-group">
                  <label for="targetGroup">Sameple data</label>
                  <input type="text" value="{{old('section_email')}}" name="section_email" class="form-control {{ $errors->has('section_email') ? 'is-invalid' : '' }}" id="section_email" placeholder="Sameple data">
              ...
              <div class="col col-md-3">
                <div class="form-group">
                  <label for="startDate">Sameple data</label>
