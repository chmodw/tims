...
//        $this->middleware('permission:User-delete', ['only' => ['destroy']]);
    ...
    public function index(Request $request)
    {
        ...
        $route = strtolower(str_replace('Program','',$request->program_type));

        return view('programs/payments/index')->with('route', $route)->with('program_id', $request->program_id);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function create($program_id, $program_type)
    {
